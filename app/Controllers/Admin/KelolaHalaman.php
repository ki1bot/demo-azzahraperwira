...
class KelolaHalaman extends BaseController
{
    ...
    private array $kodeKontenDikunci = [
        ...
        'unit-kb-tk' => ['judul_halaman', 'subjudul_halaman', 'tentang_unit', 'program_unit', 'fasilitas_unit', 'ekstrakurikuler', 'galeri_1', 'galeri_2', 'galeri_3'],
        'unit-tpq' => ['judul_halaman', 'subjudul_halaman', 'tentang_tpq', 'tentang_rtq', 'program_unit', 'kegiatan_unit', 'galeri_1', 'galeri_2', 'galeri_3'],
        'unit-dc' => ['judul_halaman', 'subjudul_halaman', 'tentang_unit', 'program_unit', 'kegiatan_unit', 'galeri_1', 'galeri_2', 'galeri_3'],
        'unit-lansia' => ['judul_halaman', 'subjudul_halaman', 'tentang_unit', 'program_unit', 'kegiatan_unit', 'galeri_1', 'galeri_2', 'galeri_3'],
        'informasi' => ['judul_halaman', 'subjudul_halaman'],
    ...
    private function pastikanKontenOtomatis(string $kodeHalaman): void
    {
        foreach ($this->kontenOtomatis[$kodeHalaman] ?? [] as $konten) {
            $kodeKonten = (string) ($konten['kode_konten'] ?? '');
            ...
            if ($this->modelKonten->satuBerdasarkanKode($kodeHalaman, $kodeKonten) !== null) {
                continue;
            }
