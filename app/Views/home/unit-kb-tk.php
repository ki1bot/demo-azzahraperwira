<div id="divUtama">
    <div class="bg-az-green py-16">
        <div class="container mx-auto px-6 text-center">
            <h1 class="text-4xl md:text-5xl font-bold text-white mb-4">KB-TK Az-Zahra Perwira</h1>
            <p class="text-az-gold text-lg italic">Membangun Fondasi Karakter dan Keimanan Sejak Dini</p>
        </div>
    </div>
    ...
    <main class="container mx-auto px-6 py-12 space-y-16">
        ...
        <section class="grid md:grid-cols-2 gap-12 items-start">
            <div>
                <h2 class="text-3xl font-bold text-az-green mb-6">Tentang KB-TK</h2>
                <p class="text-gray-600 leading-relaxed text-justify">
				Masa usia dini adalah periode yang paling menentukan dalam kehidupan seseorang—sebuah golden age di mana setiap detik adalah kesempatan untuk menanamkan nilai-nilai kebaikan yang akan tumbuh menjadi karakter kokoh di masa depan. 
            ...
            <div class="h-80 w-100 bg-slate-200 rounded-2xl overflow-hidden shadow-lg border-4 border-white">
                <img src="<?php echo base_url('assets/img/unit-kb-tk/kelas.png'); ?>" alt="Kegiatan Kelas" class="w-full h-full object-cover">
            </div>
        </section>

        <section>
            <h3 class="text-2xl font-bold text-az-green mb-8 text-center">Program Kelas</h3>
        ...
        <section class="bg-az-green text-white p-8 md:p-12 rounded-3xl">
            <h3 class="text-3xl font-bold text-az-gold mb-10 text-center">Pilar Pendidikan: Taqwa - Cerdas - Terampil</h3>
        ...
        <section class="grid md:grid-cols-3 gap-8">
            <div class="bg-white p-8 rounded-xl border-2 border-dashed border-az-gold h-64">
                <h4 class="text-xl font-bold text-az-green mb-4">Kegiatan Ekstrakurikuler</h4>
            ...
            <div class="h-64 bg-slate-200 rounded-xl overflow-hidden shadow-md">
                <img src="<?php echo base_url('assets/img/unit-kb-tk/drumband.jpg'); ?>" alt="Drumband" class="w-full h-full object-cover">
            </div>
            <div class="h-64 bg-slate-200 rounded-xl overflow-hidden shadow-md">
                <img src="<?php echo base_url('assets/img/unit-kb-tk/menari.png'); ?>" alt="Menari" class="w-full h-full object-cover">
            </div>
        </section>
